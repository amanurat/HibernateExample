...
CREATE TABLE Department ( DEPARTMENT_ID int NOT NULL AUTO_INCREMENT, DEPARTMENT_NAME varchar(255), PRIMARY KEY (DEPARTMENT_ID), CONSTRAINT DEPARTMENT_NAME UNIQUE (DEPARTMENT_NAME) ) ENGINE=InnoDB DEFAULT CHARSET=utf-8;
...
DROP TABLE EMPLOYEE;
CREATE TABLE EMPLOYEE ( EMPLOYEE_ID int NOT NULL AUTO_INCREMENT, ADDRESS varchar(255), AGE int, BIRTH_DATE datetime, CREATE_DATE datetime, EMAIL varchar(255), FIRST_NAME varchar(255), LAST_NAME varchar(255), PHONE_NUMBER varchar(255), POSITION varchar(255), SALARY int, SEX int, UPDATE_DATE datetime, DEPARTMENT_ID int, PRIMARY KEY (EMPLOYEE_ID), CONSTRAINT FK75C8D6AEC6B00FAF FOREIGN KEY (DEPARTMENT_ID) REFERENCES Department (DEPARTMENT_ID), INDEX FK75C8D6AEC6B00FAF (DEPARTMENT_ID) ) ENGINE=InnoDB DEFAULT CHARSET=utf-8;
...
DROP TABLE STUDENT;
CREATE TABLE STUDENT ( STUDENT_ID bigint NOT NULL AUTO_INCREMENT, STUDENT_NAME varchar(100) NOT NULL, EMAIL varchar(100) NOT NULL, PRIMARY KEY (STUDENT_ID) ) ENGINE=InnoDB DEFAULT CHARSET=utf-8;
